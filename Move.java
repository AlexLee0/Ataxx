...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        _isExtend = false;
        _isJump = false;
        if (abs(_row1 - _row0) == 1 && abs(_col1 - _col0) < 2
                || abs(_col1 - _col0) == 1 && abs(_row1 - _row0) < 2
                || abs(_fromIndex - _toIndex) == 1
                || abs(_fromIndex - _toIndex) == 10
                || abs(_fromIndex - _toIndex) == 11
    ...
    public String toString() {
        ...
        return Character.toString(col0())
                + Character.toString(row0())
                + "-" + Character.toString(col1())
